...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/img)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/img
```

A live public deployment of this template is available at [https://img.templates.workers.dev](https://img.templates.workers.dev)
